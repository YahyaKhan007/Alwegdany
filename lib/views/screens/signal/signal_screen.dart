...
import 'package:alwegdany/data/controller/signal/signal_controller.dart';
...
import 'package:alwegdany/views/screens/signal/widget/list_item.dart';
                                    ...
                                    children: [
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(MyStrings.signalName,
                                                style:
                                                    interNormalSmall.copyWith(
                                                        color:
                                                            MyColor.colorWhite,
                                                        fontWeight:
                                                            FontWeight.w500)),
                                          ...
                                          child: ListView.separated(
                                            ...
                                            itemBuilder: (context, index) {
                                              ...
                                              return SignalListItem(
                                                index: index,
                                                date: controller.dataList[index]
                                                        .createdAt ??
                                                    '',
                                                signalName: controller
                                                        .dataList[index]
                                                        .signal
                                                        ?.name ??
                                                    '',
