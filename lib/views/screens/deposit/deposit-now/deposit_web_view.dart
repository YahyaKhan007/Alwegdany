...
import 'package:alwegdany/views/screens/deposit/deposit-now/widget/webview_widget.dart';
...
class DepositWebView extends StatefulWidget {
  ...
  const DepositWebView({Key? key, required this.redirectUrl}) : super(key: key);
