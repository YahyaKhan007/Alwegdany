...
class UserPostModel{
  ...
  UserPostModel({
    ...
    required this.country,required this.mobileCode,required this.image,required this.address,required this.state,required this.zip,required this.city,required this.telegramUsername
  });
  ...
  factory UserPostModel.fromMap(Map<String, dynamic> map) {
    return UserPostModel(
      ...
      telegramUsername: map['telegram_username']
    );
  }
}