...
import 'package:alwegdany/views/screens/auth/registration/model/error_model.dart';
  ...
  void resetPassword() async {
    if (errors.isEmpty && password.isNotEmpty && email.isNotEmpty) {
      if (checkPasswordStrength && validatePassword(password) != null) {
        MySnackbar.error(errorList: [
          validatePassword(password) ?? 'Please enter a valid password'
        ]);
        return;
      }
      isLoading = true;
